...
((c) => {
    ...
    function Carrito(articulo) {
        ...
        function ver(articulo = 'todos') {
            return (articulo === 'todos') ? _iterable() :
                (_carrito.hasOwnProperty(articulo)) ? `${_carrito[articulo]} ${articulo}` :
...
((c) => {
    ...
    */
    ...
    //Para solucionar esto podemos hacer uso del objetivo Prototype que permite que objetos de la misma clase compartan métodos y no sean replicados en memoria de manera ineficiente
})(console.log);
