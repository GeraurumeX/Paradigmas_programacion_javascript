...
((c, d) => {
    ...
    perro2.ladrar = () => c('guauuuuu guauuuuuu');
    ...
    perro2.ladrar();
    perro2.comer();
    perro2.aparecer('https://jonmircha.github.io/edjs-paradigmas2017/img/kEnAi.jpg');
    ...
    perro3.ladrar();
    perro3.comer('zapato');
    perro3.aparecer('https://jonmircha.github.io/edjs-paradigmas2017/img/kEnAi.jpg');
    perro3_2.ladrar();
    perro3_2.comer('albondigas');
    perro3_2.aparecer('https://jonmircha.github.io/edjs-paradigmas2017/img/kEnAi.jpg');
    ...
    perro4.ladrar();
    perro4.comer('huesos');
    perro4.aparecer('https://jonmircha.github.io/edjs-paradigmas2017/img/kEnAi.jpg');
    perro4_2.ladrar();
    perro4_2.comer('bife');
    perro4_2.aparecer('https://jonmircha.github.io/edjs-paradigmas2017/img/kEnAi.jpg');
